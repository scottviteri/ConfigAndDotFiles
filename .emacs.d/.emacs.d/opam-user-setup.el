...
;; ## added by OPAM user-setup for emacs / tuareg ## 143b0f96dcb6f1eae02569f6d037dbe4 ## you can edit, but keep this line
...
(defun opam-tuareg-autoload (fct file doc args)
  (let ((load-path (cons "/home/scottviteri/opam-coq/coq-8.8.source/share/emacs/site-lisp" load-path)))
    (load file))
  (apply fct args))
